...
async def start(client, message):
    ...
    await message.reply_photo(
       ...
       reply_markup=InlineKeyboardMarkup( [[
           ...
           InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/Apexroombkp'),
           InlineKeyboardButton('🍂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/Apexroom_Chat')
           ],[
    ...
    if data == "start":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
                ...
                InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/Apexroombkp'),
                InlineKeyboardButton('🍂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/Apexroombkp_Chat')
                ],[
                InlineKeyboardButton('🍃 𝙰𝙱𝙾𝚄𝚃', callback_data='about'),
                InlineKeyboardButton('ℹ️ 𝙷𝙴𝙻𝙿', callback_data='help')
                ]]
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="https://github.com/ApexroomTG/Apex-Rename")
               ],[
